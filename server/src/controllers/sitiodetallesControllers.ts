...
class SitioDetallesControllers{
    ...
    public async create(req: Request, res: Response): Promise<any>{
        await pool.query('INSERT INTO sitios set ?', [req.params.id]);
    ...
    public async list (req: Request, res: Response){
        ...
        try{
            ...
            let words = await pool.query('SELECT * FROM sitios_detalles');
...
const sitioDetallesControllers = new SitioDetallesControllers;
export default sitioDetallesControllers;